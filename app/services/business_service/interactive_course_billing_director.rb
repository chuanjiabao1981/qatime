module BusinessService
  # 一对一直播课结账
  class InteractiveCourseBillingDirector
    ...
    def _billing_fail!(e)
      ...
      SmsWorker.perform_async(SmsWorker::SYSTEM_ALARM, error_message: "一对一结账失败-#{@lesson.id}")
    end

    # 检查课程是否可以结账
    def _check_lesson
      return false unless @lesson.teacher
      # 检查课程时长
