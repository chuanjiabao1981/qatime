...
ActiveRecord::Schema.define(version: 20170601063652) do
  ...
  create_table "action_records", force: :cascade do |t|
    ...
    t.index ["workstation_id"], name: "index_action_records_on_workstation_id", using: :btree
  end
  ...
  create_table "chat_accounts", force: :cascade do |t|
    ...
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
    t.index ["user_id"], name: "chat_accounts_user_id_unique", unique: true, using: :btree
    t.index ["user_id"], name: "index_chat_accounts_on_user_id", using: :btree
  end
  ...
  create_table "chat_join_records", force: :cascade do |t|
    ...
    t.datetime "created_at",            null: false
    t.datetime "updated_at",            null: false
    t.index ["account_id"], name: "index_chat_join_records_on_account_id", using: :btree
    t.index ["team_id"], name: "index_chat_join_records_on_team_id", using: :btree
  end
  ...
  create_table "chat_teams", force: :cascade do |t|
    ...
    t.index ["live_studio_course_id"], name: "chat_teams_course_id_unique", unique: true, using: :btree
    t.index ["live_studio_course_id"], name: "index_chat_teams_on_live_studio_course_id", using: :btree
  end
  ...
  create_table "cities", force: :cascade do |t|
    ...
    t.integer  "workstation_id"
    t.index ["workstation_id"], name: "index_cities_on_workstation_id", using: :btree
  end
  ...
  create_table "course_purchase_records", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["course_id"], name: "index_course_purchase_records_on_course_id", using: :btree
    t.index ["student_id", "course_id"], name: "student_id_course_id", unique: true, using: :btree
    t.index ["student_id"], name: "index_course_purchase_records_on_student_id", using: :btree
  end
  ...
  create_table "invitations", force: :cascade do |t|
    ...
    t.index ["target_type", "target_id"], name: "index_invitations_on_target_type_and_target_id", using: :btree
  ...
  create_table "learning_plan_assignments", force: :cascade do |t|
    ...
    t.datetime "created_at",                           null: false
    t.datetime "updated_at",                           null: false
    t.index ["learning_plan_id", "teacher_id"], name: "unique_teacher", unique: true, using: :btree
  end
  ...
  create_table "live_studio_announcements", force: :cascade do |t|
    ...
    t.index ["course_id"], name: "index_live_studio_announcements_on_course_id", using: :btree
  end
  ...
  create_table "live_studio_channels", force: :cascade do |t|
    ...
    t.index ["course_id"], name: "index_live_studio_channels_on_course_id", using: :btree
  end
  ...
  create_table "live_studio_course_requests", force: :cascade do |t|
    ...
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
    t.index ["course_id"], name: "index_live_studio_course_requests_on_course_id", using: :btree
    t.index ["user_id"], name: "index_live_studio_course_requests_on_user_id", using: :btree
    t.index ["workstation_id"], name: "index_live_studio_course_requests_on_workstation_id", using: :btree
  end
  ...
  create_table "live_studio_courses", force: :cascade do |t|
    ...
    t.index ["author_id"], name: "index_live_studio_courses_on_author_id", using: :btree
    t.index ["city_id"], name: "index_live_studio_courses_on_city_id", using: :btree
    t.index ["class_date"], name: "index_live_studio_courses_on_class_date", using: :btree
    t.index ["invitation_id"], name: "index_live_studio_courses_on_invitation_id", using: :btree
    t.index ["preset_lesson_count"], name: "index_live_studio_courses_on_preset_lesson_count", using: :btree
    t.index ["price"], name: "index_live_studio_courses_on_price", using: :btree
    t.index ["province_id"], name: "index_live_studio_courses_on_province_id", using: :btree
    t.index ["published_at"], name: "index_live_studio_courses_on_published_at", using: :btree
    t.index ["teacher_id"], name: "index_live_studio_courses_on_teacher_id", using: :btree
    t.index ["workstation_id"], name: "index_live_studio_courses_on_workstation_id", using: :btree
  end
  ...
  create_table "live_studio_interactive_courses", force: :cascade do |t|
    ...
    t.datetime "end_at"
    t.decimal  "left_price",                               precision: 10, scale: 2, default: "0.0"
    t.index ["author_id"], name: "index_live_studio_interactive_courses_on_author_id", using: :btree
    t.index ["city_id"], name: "index_live_studio_interactive_courses_on_city_id", using: :btree
    t.index ["class_date"], name: "index_live_studio_interactive_courses_on_class_date", using: :btree
    t.index ["preset_lesson_count"], name: "index_live_studio_interactive_courses_on_preset_lesson_count", using: :btree
    t.index ["price"], name: "index_live_studio_interactive_courses_on_price", using: :btree
    t.index ["province_id"], name: "index_live_studio_interactive_courses_on_province_id", using: :btree
    t.index ["published_at"], name: "index_live_studio_interactive_courses_on_published_at", using: :btree
    t.index ["status"], name: "index_live_studio_interactive_courses_on_status", using: :btree
    t.index ["workstation_id"], name: "index_live_studio_interactive_courses_on_workstation_id", using: :btree
  end
  ...
  create_table "live_studio_interactive_lessons", force: :cascade do |t|
    ...
    t.index ["interactive_course_id"], name: "index_live_studio_interactive_lessons_on_interactive_course_id", using: :btree
    t.index ["status"], name: "index_live_studio_interactive_lessons_on_status", using: :btree
    t.index ["teacher_id"], name: "index_live_studio_interactive_lessons_on_teacher_id", using: :btree
  end
  ...
  create_table "live_studio_lessons", force: :cascade do |t|
    ...
    t.integer  "duration"
    t.integer  "replay_status",              default: 0
    t.index ["course_id"], name: "index_live_studio_lessons_on_course_id", using: :btree
    t.index ["teacher_id"], name: "index_live_studio_lessons_on_teacher_id", using: :btree
  end
  ...
  create_table "live_studio_live_sessions", force: :cascade do |t|
    ...
    t.index ["lesson_id"], name: "index_live_studio_live_sessions_on_lesson_id", using: :btree
  end
  ...
  create_table "live_studio_play_records", force: :cascade do |t|
    ...
    t.index ["course_id"], name: "index_live_studio_play_records_on_course_id", using: :btree
    t.index ["lesson_id"], name: "index_live_studio_play_records_on_lesson_id", using: :btree
    t.index ["product_id", "product_type"], name: "index_live_studio_play_records_on_product_id_and_product_type", using: :btree
    t.index ["ticket_id"], name: "index_live_studio_play_records_on_ticket_id", using: :btree
    t.index ["user_id"], name: "index_live_studio_play_records_on_user_id", using: :btree
  end
  ...
  create_table "live_studio_sell_channels", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["owner_type", "owner_id"], name: "index_live_studio_sell_channels_on_owner_type_and_owner_id", using: :btree
    t.index ["target_type", "target_id"], name: "index_live_studio_sell_channels_on_target_type_and_target_id", using: :btree
  end
  ...
  create_table "live_studio_streams", force: :cascade do |t|
    ...
    t.datetime "created_at",                         null: false
    t.datetime "updated_at",                         null: false
    t.index ["channel_id"], name: "index_live_studio_streams_on_channel_id", using: :btree
  end
  ...
  create_table "live_studio_ticket_items", force: :cascade do |t|
    ...
    t.string   "target_type"
    t.integer  "target_id"
    t.index ["lesson_id"], name: "index_live_studio_ticket_items_on_lesson_id", using: :btree
    t.index ["ticket_id"], name: "index_live_studio_ticket_items_on_ticket_id", using: :btree
  end
  ...
  create_table "live_studio_tickets", force: :cascade do |t|
    ...
    t.integer  "lesson_id"
    t.integer  "status",              limit: 2,                         default: 0
    t.bigint   "buy_count",                                             default: 0
    t.bigint   "used_count",                                            default: 0
    t.string   "type"
    t.decimal  "lesson_price",                  precision: 8, scale: 2, default: "0.0"
    t.datetime "deleted_at"
    t.datetime "created_at",                                                            null: false
    ...
    t.string   "product_type"
    t.integer  "product_id"
    t.index ["course_id"], name: "index_live_studio_tickets_on_course_id", using: :btree
    t.index ["lesson_id"], name: "index_live_studio_tickets_on_lesson_id", using: :btree
    t.index ["student_id"], name: "index_live_studio_tickets_on_student_id", using: :btree
  end
  ...
  create_table "live_studio_video_courses", force: :cascade do |t|
    ...
    t.index ["author_id"], name: "index_live_studio_video_courses_on_author_id", using: :btree
    t.index ["city_id"], name: "index_live_studio_video_courses_on_city_id", using: :btree
    t.index ["class_date"], name: "index_live_studio_video_courses_on_class_date", using: :btree
    t.index ["invitation_id"], name: "index_live_studio_video_courses_on_invitation_id", using: :btree
    t.index ["preset_lesson_count"], name: "index_live_studio_video_courses_on_preset_lesson_count", using: :btree
    t.index ["price"], name: "index_live_studio_video_courses_on_price", using: :btree
    t.index ["province_id"], name: "index_live_studio_video_courses_on_province_id", using: :btree
    t.index ["published_at"], name: "index_live_studio_video_courses_on_published_at", using: :btree
    t.index ["teacher_id"], name: "index_live_studio_video_courses_on_teacher_id", using: :btree
    t.index ["workstation_id"], name: "index_live_studio_video_courses_on_workstation_id", using: :btree
  end
  ...
  create_table "live_studio_video_lessons", force: :cascade do |t|
    ...
    t.integer  "video_id"
    t.boolean  "tastable"
    t.index ["teacher_id"], name: "index_live_studio_video_lessons_on_teacher_id", using: :btree
    t.index ["video_course_id"], name: "index_live_studio_video_lessons_on_video_course_id", using: :btree
  end
  ...
  create_table "login_tokens", force: :cascade do |t|
    ...
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
    t.index ["digest_token"], name: "index_login_tokens_on_digest_token", using: :btree
  ...
  create_table "payment_billing_items", force: :cascade do |t|
    ...
    t.string   "target_type"
    t.integer  "target_id"
    t.index ["billing_id"], name: "index_payment_billing_items_on_billing_id", using: :btree
    t.index ["cash_account_id"], name: "index_payment_billing_items_on_cash_account_id", using: :btree
    t.index ["owner_type", "owner_id"], name: "index_payment_billing_items_on_owner_type_and_owner_id", using: :btree
  end
  ...
  create_table "payment_billings", force: :cascade do |t|
    ...
    t.integer  "ticket_id"
    t.index ["from_user_id"], name: "index_payment_billings_on_from_user_id", using: :btree
    t.index ["target_type", "target_id"], name: "index_payment_billings_on_target_type_and_target_id", using: :btree
  end
  ...
  create_table "payment_cash_accounts", force: :cascade do |t|
    ...
    t.string   "type"
    t.index ["owner_type", "owner_id"], name: "index_payment_cash_accounts_on_owner_type_and_owner_id", using: :btree
  end
  ...
  create_table "payment_change_records", force: :cascade do |t|
    ...
    t.index ["billing_id"], name: "index_payment_change_records_on_billing_id", using: :btree
    t.index ["cash_account_id"], name: "index_payment_change_records_on_cash_account_id", using: :btree
    t.index ["owner_type", "owner_id"], name: "index_payment_change_records_on_owner_type_and_owner_id", using: :btree
    t.index ["target_type", "target_id"], name: "index_payment_change_records_on_target_type_and_target_id", using: :btree
  end
  ...
  create_table "payment_coupons", force: :cascade do |t|
    ...
    t.datetime "created_at",                                         null: false
    t.datetime "updated_at",                                         null: false
    t.index ["code"], name: "index_payment_coupons_on_code", using: :btree
    t.index ["owner_type", "owner_id"], name: "index_payment_coupons_on_owner_type_and_owner_id", using: :btree
  end
  ...
  create_table "payment_orders", force: :cascade do |t|
    ...
    t.datetime "pay_at"
    t.index ["product_type", "product_id"], name: "index_payment_orders_on_product_type_and_product_id", using: :btree
    t.index ["user_id"], name: "index_payment_orders_on_user_id", using: :btree
  end
  ...
  create_table "payment_remote_orders", force: :cascade do |t|
    ...
    t.text     "hold_remotes"
    t.text     "hold_results"
    t.index ["order_type", "order_id"], name: "index_payment_remote_orders_on_order_type_and_order_id", using: :btree
  end
  ...
  create_table "payment_sale_tasks", force: :cascade do |t|
    ...
    t.datetime "created_at",                                                 null: false
    t.datetime "updated_at",                                                 null: false
    t.index ["target_type", "target_id"], name: "index_payment_sale_tasks_on_target_type_and_target_id", using: :btree
  end
  ...
  create_table "payment_transactions", force: :cascade do |t|
    ...
    t.integer  "seller_id"
    t.string   "seller_type"
    t.index ["close"], name: "index_payment_transactions_on_close", using: :btree
    t.index ["coupon_id"], name: "index_payment_transactions_on_coupon_id", using: :btree
    t.index ["owner_id", "owner_type"], name: "index_payment_transactions_on_owner_id_and_owner_type", using: :btree
    t.index ["seller_id", "seller_type"], name: "index_payment_transactions_on_seller_id_and_seller_type", using: :btree
  ...
  create_table "payment_withdraw_remits", force: :cascade do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["pay_type"], name: "index_payment_withdraw_remits_on_pay_type", using: :btree
    t.index ["target_type", "target_id"], name: "index_payment_withdraw_remits_on_target_type_and_target_id", using: :btree
  end
  ...
  create_table "push_messages", force: :cascade do |t|
    ...
    t.index ["creator_type", "creator_id"], name: "index_push_messages_on_creator_type_and_creator_id", using: :btree
    t.index ["push_type"], name: "index_push_messages_on_push_type", using: :btree
  end
  ...
  create_table "qr_codes", force: :cascade do |t|
    ...
    t.datetime "updated_at",       null: false
    t.integer  "coupon_id"
    t.index ["coupon_id"], name: "index_qr_codes_on_coupon_id", using: :btree
  end
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.datetime "updated_at",                      null: false
    t.integer  "comments_count",   default: 0
    t.index ["answers_info"], name: "index_questions_on_answers_info", using: :gin
    t.index ["last_answer_info"], name: "index_questions_on_last_answer_info", using: :gin
  end
  ...
  create_table "recharge_codes", force: :cascade do |t|
    ...
    t.index ["code"], name: "index_recharge_codes_on_code", using: :btree
  end
  ...
  create_table "recommend_items", force: :cascade do |t|
    ...
    t.integer  "tag_one"
    t.integer  "tag_two"
    t.index ["owner_type", "owner_id"], name: "index_recommend_items_on_owner_type_and_owner_id", using: :btree
    t.index ["position_id"], name: "index_recommend_items_on_position_id", using: :btree
    t.index ["tag_one"], name: "index_recommend_items_on_tag_one", using: :btree
    t.index ["tag_two"], name: "index_recommend_items_on_tag_two", using: :btree
    t.index ["target_type", "target_id"], name: "index_recommend_items_on_target_type_and_target_id", using: :btree
  end
  ...
  create_table "recommend_positions", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.datetime "deleted_at"
    t.index ["kee"], name: "index_recommend_positions_on_kee", using: :btree
  end
  ...
  create_table "softwares", force: :cascade do |t|
    ...
    t.string   "download_description"
    t.index ["software_category_id"], name: "index_softwares_on_software_category_id", using: :btree
  end
  ...
  create_table "tag_categories_tags", id: false, force: :cascade do |t|
    ...
    t.index ["tag_category_id"], name: "index_tag_categories_tags_on_tag_category_id", using: :btree
    t.index ["tag_id"], name: "index_tag_categories_tags_on_tag_id", using: :btree
  end
  ...
  create_table "teaching_videos", force: :cascade do |t|
    ...
    t.index ["token"], name: "index_teaching_videos_on_token", using: :btree
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["login_mobile"], name: "index_users_on_login_mobile", unique: true, using: :btree
    t.index ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true, using: :btree
    t.index ["workstation_id"], name: "index_users_on_workstation_id", using: :btree
  end
  ...
  create_table "workstations", force: :cascade do |t|
    ...
    t.decimal  "video_service_price",     precision: 4,  scale: 2, default: "0.0"
  end
