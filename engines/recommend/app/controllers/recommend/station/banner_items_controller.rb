...
module Recommend
  class Station::BannerItemsController < Station::ApplicationController
    ...
    def create
      ...
      if @item.save(placehold: true)
        flash_msg(:success)
        redirect_to recommend.station_workstation_banner_items_path(@workstation, position_id: @position)
      else
        render :new
      end
    end
