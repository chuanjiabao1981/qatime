...
ActiveRecord::Schema.define(version: 20171212082254) do
  ...
  add_index "exam_options", ["topic_id"], name: "index_exam_options_on_topic_id", using: :btree
  ...
  add_index "exam_topics", ["group_topic_id"], name: "index_exam_topics_on_group_topic_id", using: :btree
  add_index "exam_topics", ["package_topic_id"], name: "index_exam_topics_on_package_topic_id", using: :btree
  add_index "exam_topics", ["paper_id"], name: "index_exam_topics_on_paper_id", using: :btree
  ...
  add_foreign_key "exam_papers", "workstations"
