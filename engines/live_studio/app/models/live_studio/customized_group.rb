module LiveStudio
  class CustomizedGroup < Group
    has_many :scheduled_lessons, class_name: 'ScheduledLesson', -> { order('start_at asc, id asc') }, foreign_key: :group_id, dependent: :destroy
    has_many :offline_lessons, class_name: 'OfflineLesson', -> { order('start_at asc, id asc') }, foreign_key: :group_id, dependent: :destroy
