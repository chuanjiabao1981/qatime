...
class DirectoryFlowsTest < LoginTestBase
  ...
  test "directories create" do
    ...
    assert_equal 5,@syllabus.directories.count
  end

  test "directories edit" do
    @teacher_session.get CourseLibrary::Engine.routes.url_helpers.edit_syllabus_directory_path(@syllabus,@directory)
    @teacher_session.assert_response :success
  end
