...
class GroupPublicizeUploader < CarrierWave::Uploader::Base
  ...
  def default_url
    ...
    ActionController::Base.helpers.asset_path("groups/#{model.subject_name}/" + [version_name, "default.png"].compact.join('_'))
  end
