  ...
  class Manager::CoursesController < Manager::BaseController
    ...
    def create
      ...
      if @course.save
        ...
        course_action_record = @course.course_action_records.create(name: t("activerecord.view.course_action_record.name.course_create", course_name: @course.name), category: :course_create)
