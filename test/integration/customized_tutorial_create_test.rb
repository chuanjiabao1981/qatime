class CustomizedTutorialCreateTest < ActionDispatch::IntegrationTest
  ...
  test 'customized tutorial create' do
    ...
    begin
      page.save_screenshot('screenshot-customized-tutorial-create-0.png')
      ...
      page.save_screenshot('screenshot-customized-tutorial-create-1.png')

      assert_difference 'xxxx',1 do
        assert_difference 'ct_count',1 do
          page.save_screenshot('screenshot-customized-tutorial-create-2.png')
      ...
      page.save_screenshot('screenshot-customized-tutorial-create-5.png')
      l = CustomizedTutorial.all.order(:created_at => :desc).first
      page.save_screenshot('screenshot-customized-tutorial-create-6.png')
      ...
      page.save_screenshot('screenshot-customized-tutorial-create-7.png')
    rescue Capybara::ElementNotFound =>x
      page.save_screenshot('screenshot__xxxxxx-customized-tutorial-create.png')
    end
  end
