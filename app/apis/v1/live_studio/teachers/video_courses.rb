          ...
          namespace :teachers do
            ...
            route_param :teacher_id do
              ...
              params do
                ...
                optional :status, type: String, desc: '状态 unpublished: 未发布; rejected: 审核被拒; init: 初始化; confirmed: 审核通过; completed: 已创建; published: 已发布;', values: %w(unpublished rejected init confirmed completed published)
              end
